...
public class BookMarkActivity extends AppCompatActivity {
    ...
    @BindView(R.id.bookmark_rv_search_result)
    RecyclerView bookmark_rv_search_result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<CompanyInfoDTO>> call = retrofitExService.getBookMarkList();
        call.enqueue(new Callback<List<CompanyInfoDTO>>() {
            ...
            public void onResponse(Call<List<CompanyInfoDTO>> call, Response<List<CompanyInfoDTO>> response) {
                ...
                bookmark_rv_search_result.setAdapter(adapter);
                bookmark_rv_search_result.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
            }
